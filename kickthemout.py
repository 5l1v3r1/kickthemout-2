...
# -.- coding: utf-8 -.-
# kickthemout.py
# https://github.com/kennedy69/kickthemout

"""
Copyright (C) 2019 Ferdi S Kennedy (ferdi.kennedy@protonmail.com)
"""
...
try:
    ...
    if os.geteuid() != 0:
        print("\n{}ERROR: Run it on root. Try again with sudo:\n\t{}$ sudo python3 kickthemout.py{}\n".format(RED, GREEN, END))
        os._exit(1)
except:
...
def shutdown():
    print('\n\n{}Thanks for dropping by.'
          '\nSee you later!{}'.format(GREEN, END))
    os._exit(0)
...
def heading():
    ...
    '\n' + 'Code By: {0}Ferdi S Kennedy ({1}kennedy69{2})'.format(YELLOW, RED, YELLOW, BLUE).center(111) +
...
def runDebug():
    ...
    print(
    "{}Starting debug... (Please report this crash on 'https://github.com/kennedy69/kickthemout/issues' with your private information removed where necessary){}".format(
        RED, END))
    try:
